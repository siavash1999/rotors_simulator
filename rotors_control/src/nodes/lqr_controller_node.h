...
#ifndef ROTORS_CONTROL_LQR_CONTROLLER_NODE_H
#define ROTORS_CONTROL_LQR_CONTROLLER_NODE_H
...
class LqrControllerNode {
 public:
  LqrControllerNode(const ros::NodeHandle& nh, const ros::NodeHandle& private_nh);
  ~LqrControllerNode();
