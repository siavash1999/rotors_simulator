...
#ifndef ROTORS_CONTROL_PID_CONTROLLER_NODE_H
#define ROTORS_CONTROL_PID_CONTROLLER_NODE_H
...
class PidControllerNode {
 public:
  PidControllerNode(const ros::NodeHandle& nh, const ros::NodeHandle& private_nh);
  ~PidControllerNode();
...
#endif // ROTORS_CONTROL_PID_CONTROLLER_NODE_H
