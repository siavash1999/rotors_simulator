...
#ifndef ROTORS_CONTROL_PID_CONTROLLER_H
#define ROTORS_CONTROL_PID_CONTROLLER_H
...
class PidController {
 public:
  ...
  PidControllerParameters controller_parameters_;
 ...
 private:
  ...
  void CalculateRollPitchThrust(Eigen::Vector3d* roll_pitch_thrust_ptr, Eigen::Vector3d* euler_angles_ptr) const;
  void CalculateThrustMoments(Eigen::Vector4d* control_input_ptr, Eigen::Vector3d* angle_error) const;
};
}
